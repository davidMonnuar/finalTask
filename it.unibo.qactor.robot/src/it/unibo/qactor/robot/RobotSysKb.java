...
//			new Hashtable<String, Boolean>();
	...
	public static QActorContext robotActorCtx;
	...
	public static final void setRobotBase( ){
 	...
 	public static final IBaseRobot setRobotBase(QActorContext ctx, String robotName ){
...
// 		System.out.println(" *** robotBase class= " + robotBase.getClass().getName() );
	...
	public static final IBaseRobot getRobotBase( ) throws Exception{
		if( robotBase == null ) throw new Exception("no robotBase");
		else return robotBase;
	}
	public static final void setRobotActor(IRobotActor robot){
		robotActor = robot;
	}
	public static final void setRobotActor(QActorContext ctx, String robotName, InputStream resourceAsStream) throws Exception{
	...
	public static final IRobotActor getRobotActor( ){
		//System.out.println("getRobotActor " + robotActor.getName());
		return robotActor ;
	}
