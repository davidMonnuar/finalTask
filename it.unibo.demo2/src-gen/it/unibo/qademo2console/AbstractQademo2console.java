...
public abstract class AbstractQademo2console extends QActor { 
	...
	protected IActorAction  action;
		...
		public AbstractQademo2console(String actorId, QActorContext myCtx, IOutputEnvView outEnvView )  throws Exception{
			super(actorId, myCtx,  
			"./srcMore/it/unibo/qademo2console/WorldTheory.pl",
			setTheEnv( outEnvView )  , "init");		
			this.planFilePath = "./srcMore/it/unibo/qademo2console/plans.txt";
	    ...
	    while(true){
	    	...
	    	nPlanIter++;
	    		...
	    		if( currentEvent.getEventId().equals("local_inputcmd") ){
	    		 		...
	    		 		if( parg != null ) sendMsg("cmd","qrdemo2robot", QActorContext.dispatch, parg ); 
	    		 }
	    		//onEvent
	    		if( currentEvent.getEventId().equals("local_inputcmd") ){
	    		 		String parg="alarm(X)";
