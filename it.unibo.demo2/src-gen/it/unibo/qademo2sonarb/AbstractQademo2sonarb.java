...
public abstract class AbstractQademo2sonarb extends QActor { 
	...
	protected IActorAction  action;
		...
		public AbstractQademo2sonarb(String actorId, QActorContext myCtx, IOutputEnvView outEnvView )  throws Exception{
			super(actorId, myCtx,  
			"./srcMore/it/unibo/qademo2sonarb/WorldTheory.pl",
			setTheEnv( outEnvView )  , "init");		
			this.planFilePath = "./srcMore/it/unibo/qademo2sonarb/plans.txt";
