...
public abstract class AbstractQademo2sonara extends QActor { 
	...
	protected IActorAction  action;
		...
		public AbstractQademo2sonara(String actorId, QActorContext myCtx, IOutputEnvView outEnvView )  throws Exception{
			super(actorId, myCtx,  
			"./srcMore/it/unibo/qademo2sonara/WorldTheory.pl",
			setTheEnv( outEnvView )  , "init");		
			this.planFilePath = "./srcMore/it/unibo/qademo2sonara/plans.txt";
		...
		*/
	    ...
	    while(true){
	    	...
	    	nPlanIter++;
	    		temporaryStr = QActorUtils.unifyMsgContent(pengine,"sonar(SONARNAME,TARGETNAME,DISTANCE)","sonar(sonara,qrdemo2robot,50)", guardVars ).toString();
