%==============================================
% WorldTheory.pl for actor qademo2sonara
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqademo2sonara).	%%old version (deprecated)
actorobj(qatuqademo2sonara).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qademo2sonara
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qademo2sonara" ). 
...
%-------------------------------------------------
%  User static rules about qademo2sonara
%------------------------------------------------- 
