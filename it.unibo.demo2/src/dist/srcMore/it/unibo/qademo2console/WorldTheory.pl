%==============================================
% WorldTheory.pl for actor qademo2console
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqademo2console).	%%old version (deprecated)
actorobj(qatuqademo2console).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qademo2console
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qademo2console" ). 
...
%-------------------------------------------------
%  User static rules about qademo2console
%------------------------------------------------- 
/*
------------------------------------------------------------------------
