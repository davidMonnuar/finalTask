%==============================================
% WorldTheory.pl for actor qademo2sonarb
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqademo2sonarb).	%%old version (deprecated)
actorobj(qatuqademo2sonarb).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qademo2sonarb
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qademo2sonarb" ). 
...
%-------------------------------------------------
%  User static rules about qademo2sonarb
%------------------------------------------------- 
