%==============================================
% WorldTheory.pl for actor qrdemo2robot
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqrdemo2robot).	%%old version (deprecated)
actorobj(qatuqrdemo2robot).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qrdemo2robot
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qrdemo2robot" ). 
...
%-------------------------------------------------
%  User static rules about qrdemo2robot
%------------------------------------------------- 
