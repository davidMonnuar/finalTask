%==============================================
% WorldTheory.pl for actor qademo0sonarb
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqademo0sonarb).	%%old version (deprecated)
actorobj(qatuqademo0sonarb).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qademo0sonarb
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qademo0sonarb" ). 
...
%-------------------------------------------------
%  User static rules about qademo0sonarb
%------------------------------------------------- 
/*
------------------------------------------------------------------------
