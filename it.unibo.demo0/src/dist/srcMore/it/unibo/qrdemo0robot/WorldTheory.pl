%==============================================
% WorldTheory.pl for actor qrdemo0robot
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqrdemo0robot).	%%old version (deprecated)
actorobj(qatuqrdemo0robot).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qrdemo0robot
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qrdemo0robot" ). 
...
%-------------------------------------------------
%  User static rules about qrdemo0robot
%------------------------------------------------- 
