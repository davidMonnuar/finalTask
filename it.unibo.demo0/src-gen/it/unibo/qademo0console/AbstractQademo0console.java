...
public abstract class AbstractQademo0console extends QActor { 
	...
	protected IActorAction  action;
		...
		public AbstractQademo0console(String actorId, QActorContext myCtx, IOutputEnvView outEnvView )  throws Exception{
			super(actorId, myCtx,  
			"./srcMore/it/unibo/qademo0console/WorldTheory.pl",
			setTheEnv( outEnvView )  , "init");		
			this.planFilePath = "./srcMore/it/unibo/qademo0console/plans.txt";
		...
		*/
	    ...
	    while(true){
	    	...
	    	nPlanIter++;
	    		...
	    		sendMsg("cmd","qrdemo0robot", QActorContext.dispatch, temporaryStr ); 
