...
package it.unibo.cxt_demo0SonarB;
...
public class MainCxt_demo0SonarB   {
...
*/
	...
	public static void main(String[] args) throws Exception{
			...
			"Env_cxt_demo0SonarB",java.awt.Color.green , java.awt.Color.black );
		env.init();
		outEnvView = env.getOutputEnvView();
		    String webDir = null;
			QActorContext.initQActorSystem(
				"cxt_demo0sonarb", "./srcMore/it/unibo/cxt_demo0SonarB/demo0sys.pl", 
				"./srcMore/it/unibo/cxt_demo0SonarB/sysRules.pl", outEnvView,webDir, false);
 	}
