...
public abstract class AbstractQademo0sonarb extends QActor { 
	...
	protected IActorAction  action;
		...
		public AbstractQademo0sonarb(String actorId, QActorContext myCtx, IOutputEnvView outEnvView )  throws Exception{
			super(actorId, myCtx,  
			"./srcMore/it/unibo/qademo0sonarb/WorldTheory.pl",
			setTheEnv( outEnvView )  , "init");		
			this.planFilePath = "./srcMore/it/unibo/qademo0sonarb/plans.txt";
		...
		*/
	    ...
	    while(true){
	    	...
	    	nPlanIter++;
	    		//senseEvent
	    		aar = planUtils.senseEvents( 100000,"local_sonarb","continue",
	    		...
	    		//onEvent
	    		if( currentEvent.getEventId().equals("local_sonarb") ){
	    		 		String parg="sonar(sonarb,qrdemo0robot,D)";
	    		 		/* SendDispatch */
	    		 		parg = updateVars(Term.createTerm("sonarb(D)"),  Term.createTerm("sonarb(D)"), 
	    		 			    		  					Term.createTerm(currentEvent.getMsg()), parg);
	    		 		if( parg != null ) sendMsg("sonar","qrdemo0robot", QActorContext.dispatch, parg ); 
	    		 }
