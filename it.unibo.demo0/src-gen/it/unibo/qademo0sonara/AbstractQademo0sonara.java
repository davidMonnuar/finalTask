...
public abstract class AbstractQademo0sonara extends QActor { 
	...
	protected IActorAction  action;
		...
		public AbstractQademo0sonara(String actorId, QActorContext myCtx, IOutputEnvView outEnvView )  throws Exception{
			super(actorId, myCtx,  
			"./srcMore/it/unibo/qademo0sonara/WorldTheory.pl",
			setTheEnv( outEnvView )  , "init");		
			this.planFilePath = "./srcMore/it/unibo/qademo0sonara/plans.txt";
		...
		*/
	    ...
	    while(true){
	    	...
	    	nPlanIter++;
	    		//senseEvent
	    		aar = planUtils.senseEvents( 100000,"local_sonara","continue",
	    		...
	    		//onEvent
	    		if( currentEvent.getEventId().equals("local_sonara") ){
	    		 		String parg="sonar(sonara,qrdemo0robot,D)";
	    		 		/* SendDispatch */
	    		 		parg = updateVars(Term.createTerm("sonara(D)"),  Term.createTerm("sonara(D)"), 
