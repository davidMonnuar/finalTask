%==============================================
% WorldTheory.pl for actor qademo0console
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqademo0console).	%%old version (deprecated)
actorobj(qatuqademo0console).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qademo0console
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qademo0console" ). 
...
%-------------------------------------------------
%  User static rules about qademo0console
%------------------------------------------------- 
/*
------------------------------------------------------------------------
