%==============================================
% WorldTheory.pl for actor qademo0sonara
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqademo0sonara).	%%old version (deprecated)
actorobj(qatuqademo0sonara).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qademo0sonara
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qademo0sonara" ). 
...
%-------------------------------------------------
%  User static rules about qademo0sonara
%------------------------------------------------- 
/*
------------------------------------------------------------------------
