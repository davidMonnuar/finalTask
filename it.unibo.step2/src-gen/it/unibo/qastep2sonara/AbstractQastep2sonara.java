...
public abstract class AbstractQastep2sonara extends QActor { 
	...
	protected IActorAction  action;
		...
		public AbstractQastep2sonara(String actorId, QActorContext myCtx, IOutputEnvView outEnvView )  throws Exception{
			super(actorId, myCtx,  
			"./srcMore/it/unibo/qastep2sonara/WorldTheory.pl",
			setTheEnv( outEnvView )  , "init");		
			this.planFilePath = "./srcMore/it/unibo/qastep2sonara/plans.txt";
		...
		*/
	    ...
	    while(true){
	    	...
	    	nPlanIter++;
	    		...
	    		temporaryStr = QActorUtils.unifyMsgContent(pengine,"sonar(SONARNAME,TARGETNAME,DISTANCE)","sonar(sonara,qrstep2robot,D)", guardVars ).toString();
	    		sendMsg("sonar","qrstep2robot", QActorContext.dispatch, temporaryStr ); 
	    		}
