%==============================================
% WorldTheory.pl for actor qrstep2robot
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqrstep2robot).	%%old version (deprecated)
actorobj(qatuqrstep2robot).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qrstep2robot
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qrstep2robot" ). 
...
%-------------------------------------------------
%  User static rules about qrstep2robot
%------------------------------------------------- 
