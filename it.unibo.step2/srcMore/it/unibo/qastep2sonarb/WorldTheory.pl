%==============================================
% WorldTheory.pl for actor qastep2sonarb
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqastep2sonarb).	%%old version (deprecated)
actorobj(qatuqastep2sonarb).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qastep2sonarb
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qastep2sonarb" ). 
...
%-------------------------------------------------
%  User static rules about qastep2sonarb
%------------------------------------------------- 
