%==============================================
% WorldTheory.pl for actor qastep2sonara
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqastep2sonara).	%%old version (deprecated)
actorobj(qatuqastep2sonara).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qastep2sonara
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qastep2sonara" ). 
...
%-------------------------------------------------
%  User static rules about qastep2sonara
%------------------------------------------------- 
