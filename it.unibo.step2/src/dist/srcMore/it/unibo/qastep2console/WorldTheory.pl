%==============================================
% WorldTheory.pl for actor qastep2console
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqastep2console).	%%old version (deprecated)
actorobj(qatuqastep2console).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qastep2console
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qastep2console" ). 
...
%-------------------------------------------------
%  User static rules about qastep2console
%------------------------------------------------- 
/*
------------------------------------------------------------------------
