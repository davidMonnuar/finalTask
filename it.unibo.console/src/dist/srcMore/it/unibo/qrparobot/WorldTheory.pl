%==============================================
% WorldTheory.pl for actor qrparobot
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqrparobot).	%%old version (deprecated)
actorobj(qatuqrparobot).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qrparobot
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qrparobot" ). 
...
%------------------------------------------------- 
distB( D):-distinB( D), ! ,assert( ugualeB( D,D)).
distB( D):-eval( lt,D,distA( C)), ! ,assert( minore( B,A)).
distB( D):-eval( gt,D,distA( C)), ! ,assert( maggiore( B,A)).
