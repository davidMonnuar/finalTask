%==============================================
% WorldTheory.pl for actor qapasonarb
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqapasonarb).	%%old version (deprecated)
actorobj(qatuqapasonarb).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qapasonarb
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qapasonarb" ). 
...
%-------------------------------------------------
%  User static rules about qapasonarb
%------------------------------------------------- 
/*
------------------------------------------------------------------------
