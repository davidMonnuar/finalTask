%==============================================
% WorldTheory.pl for actor qapasonara
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqapasonara).	%%old version (deprecated)
actorobj(qatuqapasonara).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qapasonara
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qapasonara" ). 
