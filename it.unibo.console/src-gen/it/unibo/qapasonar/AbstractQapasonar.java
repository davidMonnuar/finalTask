...
public abstract class AbstractQapasonar extends QActor { 
	...
	protected IActorAction  action;
		...
		public AbstractQapasonar(String actorId, QActorContext myCtx, IOutputEnvView outEnvView )  throws Exception{
			super(actorId, myCtx,  
			"./srcMore/it/unibo/qapasonar/WorldTheory.pl",
			setTheEnv( outEnvView )  , "init");		
			this.planFilePath = "./srcMore/it/unibo/qapasonar/plans.txt";
