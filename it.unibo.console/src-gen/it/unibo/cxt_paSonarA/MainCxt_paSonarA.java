...
*/
	...
	public static void main(String[] args) throws Exception{
			...
			"Env_cxt_paSonarA",java.awt.Color.blue , java.awt.Color.black );
		env.init();
		outEnvView = env.getOutputEnvView();
		    String webDir = null;
			QActorContext.initQActorSystem(
				"cxt_pasonara", "./srcMore/it/unibo/cxt_paSonarA/pasys.pl", 
				"./srcMore/it/unibo/cxt_paSonarA/sysRules.pl", outEnvView,webDir, false);
 	}
