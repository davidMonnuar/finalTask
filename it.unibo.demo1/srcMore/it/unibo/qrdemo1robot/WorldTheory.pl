%==============================================
% WorldTheory.pl for actor qrdemo1robot
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqrdemo1robot).	%%old version (deprecated)
actorobj(qatuqrdemo1robot).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qrdemo1robot
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qrdemo1robot" ). 
...
%-------------------------------------------------
%  User static rules about qrdemo1robot
%------------------------------------------------- 
