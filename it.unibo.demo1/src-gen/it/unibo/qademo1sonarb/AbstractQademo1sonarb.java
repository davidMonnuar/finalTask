...
package it.unibo.qademo1sonarb;
...
public abstract class AbstractQademo1sonarb extends QActor { 
	...
	protected IActorAction  action;
		...
		public AbstractQademo1sonarb(String actorId, QActorContext myCtx, IOutputEnvView outEnvView )  throws Exception{
			super(actorId, myCtx,  
			"./srcMore/it/unibo/qademo1sonarb/WorldTheory.pl",
			setTheEnv( outEnvView )  , "init");		
			this.planFilePath = "./srcMore/it/unibo/qademo1sonarb/plans.txt";
		...
		*/
	    ...
	    while(true){
	    	...
	    	nPlanIter++;
	    		...
	    		temporaryStr = QActorUtils.unifyMsgContent(pengine,"sonar(SONARNAME,TARGETNAME,DISTANCE)","sonar(sonarb,qrdemo1robot,D)", guardVars ).toString();
