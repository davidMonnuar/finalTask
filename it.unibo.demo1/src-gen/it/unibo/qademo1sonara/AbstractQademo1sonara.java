...
package it.unibo.qademo1sonara;
...
public abstract class AbstractQademo1sonara extends QActor { 
	...
	protected IActorAction  action;
		...
		public AbstractQademo1sonara(String actorId, QActorContext myCtx, IOutputEnvView outEnvView )  throws Exception{
			super(actorId, myCtx,  
			"./srcMore/it/unibo/qademo1sonara/WorldTheory.pl",
			setTheEnv( outEnvView )  , "init");		
			this.planFilePath = "./srcMore/it/unibo/qademo1sonara/plans.txt";
		...
		*/
	    ...
	    while(true){
	    	...
	    	nPlanIter++;
	    		...
	    		temporaryStr = QActorUtils.unifyMsgContent(pengine,"sonar(SONARNAME,TARGETNAME,DISTANCE)","sonar(sonara,qrdemo1robot,D)", guardVars ).toString();
	    		sendMsg("sonar","qrdemo1robot", QActorContext.dispatch, temporaryStr ); 
	    		}
