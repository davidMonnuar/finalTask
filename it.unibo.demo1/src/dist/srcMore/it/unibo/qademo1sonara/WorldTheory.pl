%==============================================
% WorldTheory.pl for actor qademo1sonara
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqademo1sonara).	%%old version (deprecated)
actorobj(qatuqademo1sonara).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qademo1sonara
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qademo1sonara" ). 
...
%-------------------------------------------------
%  User static rules about qademo1sonara
%------------------------------------------------- 
