%==============================================
% WorldTheory.pl for actor qademo1console
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqademo1console).	%%old version (deprecated)
actorobj(qatuqademo1console).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qademo1console
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qademo1console" ). 
...
%-------------------------------------------------
%  User static rules about qademo1console
%------------------------------------------------- 
/*
------------------------------------------------------------------------
