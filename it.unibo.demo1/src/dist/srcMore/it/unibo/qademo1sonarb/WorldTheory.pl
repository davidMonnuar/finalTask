%==============================================
% WorldTheory.pl for actor qademo1sonarb
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqademo1sonarb).	%%old version (deprecated)
actorobj(qatuqademo1sonarb).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qademo1sonarb
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qademo1sonarb" ). 
...
%-------------------------------------------------
%  User static rules about qademo1sonarb
%------------------------------------------------- 
