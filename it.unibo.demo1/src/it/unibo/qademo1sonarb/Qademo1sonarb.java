...
public class Qademo1sonarb extends AbstractQademo1sonarb implements IActivity { 
	private BufferedReader readerC;
	public Qademo1sonarb(String actorId, QActorContext myCtx, IOutputEnvView outEnvView )  throws Exception{
