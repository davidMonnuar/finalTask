...
public class Qademo1console extends AbstractQademo1console implements IActivity { 
	public Qademo1console(String actorId, QActorContext myCtx, IOutputEnvView outEnvView )  throws Exception{
