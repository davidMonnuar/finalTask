...
package it.unibo.qasprint1sonar;
...
public abstract class AbstractQasprint1sonar extends QActor { 
	...
	protected IActorAction  action;
		...
		public AbstractQasprint1sonar(String actorId, QActorContext myCtx, IOutputEnvView outEnvView )  throws Exception{
			super(actorId, myCtx,  
			"./srcMore/it/unibo/qasprint1sonar/WorldTheory.pl",
			setTheEnv( outEnvView )  , "init");		
			this.planFilePath = "./srcMore/it/unibo/qasprint1sonar/plans.txt";
