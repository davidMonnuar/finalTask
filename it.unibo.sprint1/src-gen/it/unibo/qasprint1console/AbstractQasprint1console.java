...
public abstract class AbstractQasprint1console extends QActor { 
	...
	protected IActorAction  action;
		...
		public AbstractQasprint1console(String actorId, QActorContext myCtx, IOutputEnvView outEnvView )  throws Exception{
			super(actorId, myCtx,  
			"./srcMore/it/unibo/qasprint1console/WorldTheory.pl",
			setTheEnv( outEnvView )  , "init");		
			this.planFilePath = "./srcMore/it/unibo/qasprint1console/plans.txt";
		...
		*/
	    ...
	    while(true){
	    	...
	    	nPlanIter++;
	    		...
	    		temporaryStr = "\"#######Stop Remote Console########\"";
	    		println( temporaryStr );  
	    		//delay
	    ...
	    while(true){
	    	...
	    	nPlanIter++;
	    		...
	    		sendMsg("cmd","qasprint1robot", QActorContext.dispatch, temporaryStr ); 
