%==============================================
% WorldTheory.pl for actor qasprint1sonar
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqasprint1sonar).	%%old version (deprecated)
actorobj(qatuqasprint1sonar).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qasprint1sonar
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qasprint1sonar" ). 
...
%-------------------------------------------------
%  User static rules about qasprint1sonar
%------------------------------------------------- 
/*
------------------------------------------------------------------------
