%==============================================
% WorldTheory.pl for actor qasprint1console
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqasprint1console).	%%old version (deprecated)
actorobj(qatuqasprint1console).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qasprint1console
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qasprint1console" ). 
...
%-------------------------------------------------
%  User static rules about qasprint1console
%------------------------------------------------- 
/*
------------------------------------------------------------------------
