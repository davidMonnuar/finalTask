%==============================================
% WorldTheory.pl for actor qasprint1robot
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqasprint1robot).	%%old version (deprecated)
actorobj(qatuqasprint1robot).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qasprint1robot
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qasprint1robot" ). 
...
%-------------------------------------------------
%  User static rules about qasprint1robot
%------------------------------------------------- 
/*
------------------------------------------------------------------------
