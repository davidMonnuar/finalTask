%==============================================
% WorldTheory.pl for actor qapaconsole
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqapaconsole).	%%old version (deprecated)
actorobj(qatuqapaconsole).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qapaconsole
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qapaconsole" ). 
...
%-------------------------------------------------
%  User static rules about qapaconsole
%------------------------------------------------- 
/*
------------------------------------------------------------------------
