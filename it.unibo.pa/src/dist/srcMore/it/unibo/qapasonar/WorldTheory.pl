%==============================================
% WorldTheory.pl for actor qapasonar
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqapasonar).	%%old version (deprecated)
actorobj(qatuqapasonar).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qapasonar
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qapasonar" ). 
...
%-------------------------------------------------
%  User static rules about qapasonar
%------------------------------------------------- 
/*
------------------------------------------------------------------------
